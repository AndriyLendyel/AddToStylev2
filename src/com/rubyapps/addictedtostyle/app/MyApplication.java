...
public class MyApplication extends Application {
    ...
    private List<GridItem> items = new ArrayList<GridItem>(Arrays.asList(new GridItem(R.drawable.fashion, "Fashion",
	    "http://www.fashionpolicenigeria.com/"),// TODO read-more
	    new GridItem(R.drawable.beauty, "Beauty", "http://www.kamdora.com/"), new GridItem(R.drawable.hair, "Hair",
		    ...
		    "http://blog.glamafrica.com/category/celebs/"), new GridItem(R.drawable.lifestyle_relationships, "Lifestyle: Relationship",
		    "http://www.cosmopolitan.ng/relationships/"), new GridItem(R.drawable.diy_fashion_tips, "DIY Fashion Tips",
		    "http://addictedtostyle.net/"), new GridItem(R.drawable.juicy_gist, "Juicy Gist", "http://yabaleftonline.com/"), new GridItem(
		    R.drawable.giveaway, "Giveaway", "http://addictedtostyle.net/category/giveaway/"), new GridItem(R.drawable.rate_us,
